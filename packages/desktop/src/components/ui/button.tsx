...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "glass-card text-foreground hover:bg-white/10 glow-indigo",
        destructive: "bg-destructive/90 text-destructive-foreground hover:bg-destructive glass-card",
        outline: "border border-white/10 bg-transparent hover:bg-white/5 text-foreground",
        secondary: "bg-secondary/60 text-secondary-foreground hover:bg-secondary/80 glass-card",
