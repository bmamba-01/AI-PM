...
export function ReportsTab({ project }: Props) {
  ...
  return (
    <div className="space-y-6">
      {showGuide && (
        <SetupGuideDialog
          title="Reports Setup Guide"
          purpose="View workflow execution history, generated artifacts, and audit trail. Reports are generated by daily/weekly workflows and stored locally."
          requiredSetup={[
            "Workflow runs completed (daily, weekly, risk, scope)",
            "Memory store active for artifact tracking",
          ]}
          cliEquivalent="ai-pm audit list --json"
